...
import csv
import pandas as pd
file = 'Jonathan_BYB_Recording_2022-01-07_12.16.50.wav'
...
y=smoothTriangle(AlphaRange, 10)
plt.plot(t, y)
plt.xlabel('Time [s]')
plt.xlim(0,max(t))
...
tg=np.array([3, 10, 48, 90, 130, 140, 170, 180, 200, 210, 230 ,250, 270, 290, 310, 350, 360, 370, max(t)+1])
length_t=np.shape(t)
l_row_t=length_t[0]
eyesclosed=[]
eyesopen=[]
